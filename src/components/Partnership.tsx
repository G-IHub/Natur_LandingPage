      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-8">
        <div className="relative rounded-4xl overflow-hidden bg-linear-to-br from-[#0cba1e] to-[#055e0c]">
          ...
          <div className="relative z-10 px-10 py-16 lg:px-20 lg:py-24 max-w-[800px]">
            <h2 className="text-3xl lg:text-[3rem] font-bold text-white mb-8 leading-tight tracking-tight">
              How to work together <span className="opacity-90">.</span>
            </h2>
            <p className="text-white/90 text-base font-medium lg:text-lg leading-7 mb-8 max-w-[650px]">
