...
const BottomCTA: React.FC = () => {
  return (
    <section className="py-16 md:py-30 px-2 md:px-20 bg-[#EDFFEE] font-[Inter]">
      <div className="relative rounded-4xl overflow-hidden bg-linear-to-br from-[#0cba1e] to-[#055e0c] shadow-2xl px-4 py-8 md:py-20 md:px-16 text-center">
        ...
        <div className="rotate-180 absolute inset-0 w-full h-full hidden lg:block">
          <svg
        ...
        <div className="relative z-10 md:max-w-200 md:mx-auto flex flex-col items-center gap-4 md:gap-6">
          <h2 className="text-2xl lg:text-[3rem] font-bold text-white leading-tight tracking-tight">
            Your body deserves answers rooted in nature — not guesswork.
          </h2>
          <p className="text-white/90 font-medium text-sm lg:text-[1.1rem] leading-relaxed">
